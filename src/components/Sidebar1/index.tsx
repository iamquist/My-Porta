      ...
      >
        <div className="ml-8 mr-10">
          <MenuItem
            ...
            suffix={
              <Img src="img_enlarge.svg" width={14} height={14} alt="Enlarge" className="h-[14px] w-[14px] self-end" />
            }
          >
            MY PORTA
          </MenuItem>
          <SubMenu
            icon={
              <Img src="img_folder_indigo_a200.svg" width={24} height={24} alt="Folder" className="h-[24px] w-[24px]" />
            }
            label="All files"
          >
            <div>
          ...
          <MenuItem 
            icon={<Img src="img_meeting.svg" width={24} height={24} alt="Meeting" className="h-[24px] w-[24px]" />}
           >
            Shared with me
          </MenuItem>
